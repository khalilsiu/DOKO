...
var _useMoralisAuth = function (options) {
    ...
    var authenticate = react$1.useCallback(function (_a) {
        var _b = _a === void 0 ? {} : _a, onComplete = _b.onComplete, onError = _b.onError, onSuccess = _b.onSuccess, throwOnError = _b.throwOnError, type = _b.type, provider = _b.provider, chainId = _b.chainId, signingMessage = _b.signingMessage;
        return __awaiter(void 0, void 0, void 0, function () {
            var user, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, moralis.Moralis.Web3.authenticate(__assign(__assign(__assign(__assign({}, (!!type && { type: type })), (!!provider && { provider: provider })), (!!chainId && { chainId: chainId })), (!!signingMessage && { signingMessage: signingMessage })))];
                    case 2:
                        user = _c.sent();
                        setUser(user);
                        setAuth({
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, moralis.Moralis.Web3.enable(__assign(__assign({}, (!!provider && { provider: provider })), (!!chainId && { chainId: chainId })))];
                    case 2:
                        currentWeb3 = _c.sent();
                        setWeb3(currentWeb3);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, moralis.Moralis.Web3.executeFunction(allParams)];
                case 1: 
                //@ts-ignore
    ...
    var call = react$1.useCallback(function (callParams) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    allParams = __assign(__assign({}, params), callParams);
                    return [4 /*yield*/, moralis.Moralis.Web3.transfer(allParams)];
                case 1: 
                //@ts-ignore
                return [2 /*return*/, _a.sent()];
            }
