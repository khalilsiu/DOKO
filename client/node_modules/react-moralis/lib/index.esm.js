        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, Moralis.Web3.authenticate(__assign(__assign(__assign(__assign({}, (!!type && { type: type })), (!!provider && { provider: provider })), (!!chainId && { chainId: chainId })), (!!signingMessage && { signingMessage: signingMessage })))];
                    case 2:
                        user = _c.sent();
                        setUser(user);
                        setAuth({
