...
function EnhancedTableHead({ order, orderBy, headCells, unsortableHeaderIds, onRequestSort }: EnhancedTableProps) {
...
function Pagination({
  ...
  return (
    <div className={classes.tablePaginationContainer}>
      <div className={classes.leftPaginationBtnContainer} onClick={() => handleChangePage(page - 1)}>
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <div className={classes.rightPaginationBtnContainer} onClick={() => handleChangePage(page + 1)}>
    ...
    () =>
      stableSort(rows, getComparator(order, orderBy)).filter((row) => {
        ...
        return (
          ...
          row[dateFilterHeaderId] > new Date(endOfToday.setDate(endOfToday.getDate() - (daysToFilter as number)))
        );
      }),
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          {daysFilter.map((days) => (
            <div
              ...
              style={{
                ...(days.value === daysToFilter && { borderColor: 'white' }),
              }}
            >
