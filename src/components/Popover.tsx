...
export const Popover = ({ children, reference, placement = 'bottom-start', style }: PropsWithChildren<Props>) => {
  ...
  return (
    <div style={style}>
      <span ref={setReferenceElement} onMouseEnter={() => toggleShow(true)} onMouseLeave={() => toggleShow(false)}>
        {reference}
      </span>
      <Wrapper
