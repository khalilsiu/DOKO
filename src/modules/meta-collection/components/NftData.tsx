  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.section}>
        <Grid container spacing={4} style={{ marginBottom: '2rem' }} justifyContent="center" alignItems="stretch">
          ...
          <Grid item xs={12} md={6} lg={4} xl={3}>
            <div className={classes.dataContainer}>
              ...
              <Grid container alignItems="center">
                <img style={{ marginRight: 8 }} height={24} src="/collection/DOKOasset_EthereumBlue.png" alt="" />
