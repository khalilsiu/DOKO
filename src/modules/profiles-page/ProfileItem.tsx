    ...
    <Grid item xs={12} sm={6} lg={4} style={{ minWidth: '25vw' }}>
      <Grid className={styles.card}>
          ...
          <div>
            ...
            >
              <MenuItem
                ...
                onClick={(e) => {
                  navigator.clipboard.writeText(`https://doko.one/profiles/$${cookies.profiles[profile].hash}`);
                  handleClose(e);
                }}
              >
                Copy URL
        ...
        {cookies.profiles[profile].address.length ? (
          <Grid container direction="column" alignItems="center" style={{ height: '80%' }} wrap="nowrap">
          ...
          <Grid container alignItems="center" justifyContent="center" style={{ height: '80%' }}>
            <Typography style={{ fontFamily: 'Open Sans', fontSize: '21px' }}>No addresses found</Typography>
          </Grid>
        )}
      </Grid>
    </Grid>
