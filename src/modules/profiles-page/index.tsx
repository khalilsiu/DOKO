...
export const Profiles = () => {
  ...
  const handleDeleteAddress = (address: string) => {
    ...
    profiles[editProfile].hash = btoa(
      JSON.stringify({
        name: editProfile,
        address: profiles[editProfile].address,
      }),
    );
    setCookie('profiles', profiles, { path: '/' });
  };
    ...
    <div>
      ...
      <Modal open={createProfile}>
        <div className={styles.createProfileDialog}>
          <Grid container direction="row" justifyContent="space-between" alignItems="center" style={{ height: '24%' }}>
          ...
          <Grid container direction="row" justifyContent="center" alignItems="center" style={{ height: '52%' }}>
            <OutlinedInput
              value={profileName}
              onChange={(e) => {
          ...
          <hr style={{ width: '100%', margin: 0 }} />
          <Grid container direction="row" justifyContent="flex-end" alignItems="center" style={{ height: '24%' }}>
            <Button
  ...
  const renderEditPage = () => (
    <div>
      <Grid className={styles.itemsContainer} container direction="column" alignItems="flex-start">
        ...
        <Grid container alignItems="center" style={{ paddingBottom: 40 }}>
          <Typography className={styles.descriptionText}>
            This is where you can view, edit or delete each of your profiles. You can only have a maximum of 6 addresses
            per profile.
          </Typography>
        </Grid>
      ...
      <Modal open={addAddress}>
        <div className={styles.addAddressDialog}>
          <Grid container direction="row" justifyContent="space-between" alignItems="center" style={{ height: '12%' }}>
            <Typography variant="h4" style={{ marginLeft: 30, fontSize: 25, fontWeight: 'bold' }}>
              Add an Address
            </Typography>
          ...
          <hr style={{ width: '100%', margin: 0 }} />
          <Grid container direction="row" justifyContent="flex-end" alignItems="center" style={{ height: '12%' }}>
            <Button
              style={{ width: 170, marginRight: 34 }}
              className="gradient-button"
              variant="outlined"
